...
return [
    ...
    'mail' => [
       ...
       'addr'            => 'cat_lkk@163.com', // 发件邮箱地址邮箱格式地址
       'pass'            => 'lishishouquanma1', // 发件邮箱密码 smtp服务密码，有些是登录密码，qq邮箱是smtp服务密码
       'name'            => 'cat_lkk@163.com', // 发件邮箱名称
       'content_type'    => 'text/html', // 默认文本内容 text/html|text/plain
       'charset'         => 'utf-8', // 默认字符集
       'security'        => 'tls', // 加密方式 null|ssl|tls, QQ邮箱必须使用ssl
      // 'sendmail'        => 'cat_lkk@163.com', // 不适用 sendmail 驱动不需要配置
       ...
       'log_path'        => __DIR__.'/../Mail-logs/', // 日志路径, 可选, 不配置日志驱动时启用默认日志驱动, 默认路径是 /path/to/tp-mailer/log, 要保证该目录有可写权限, 最好配置自己的日志路径
